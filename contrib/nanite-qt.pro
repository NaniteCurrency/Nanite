...
RESOURCES += src/qt/nanite.qrc src/qt/nanite_locale.qrc

TRANSLATIONS += src/qt/locale/nanite_bg.ts \
                src/qt/locale/nanite_de.ts \
                src/qt/locale/nanite_en.ts \
                src/qt/locale/nanite_es.ts \
                src/qt/locale/nanite_fi.ts \
                src/qt/locale/nanite_fr.ts \
                src/qt/locale/nanite_it.ts \
                src/qt/locale/nanite_ja.ts \
                src/qt/locale/nanite_pl.ts \
                src/qt/locale/nanite_pt.ts \
                src/qt/locale/nanite_ru.ts \
                src/qt/locale/nanite_sk.ts \
                src/qt/locale/nanite_sv.ts \
                src/qt/locale/nanite_vi.ts \
                src/qt/locale/nanite_zh_CN.ts \
                src/qt/locale/nanite_zh_TW.ts
