...
This means one can have an always-on nanited instance running, and another local nanited/nanite-qt instance which connects to this node and receives blocks from it.
