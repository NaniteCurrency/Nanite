...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nanite Core nanite-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nanite-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nanite transaction") + "\n" +
                               "  nanite-tx [options] -create [commands]   " + _("Create hex-encoded nanite transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nanite transaction
