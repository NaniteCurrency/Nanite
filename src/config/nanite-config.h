/* src/config/nanite-config.h.  Generated from nanite-config.h.in by configure.  */
/* src/config/nanite-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.nanite.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Nanite Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Nanite Core 3.0.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "nanite"
