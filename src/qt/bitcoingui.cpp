                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NANITE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NANITE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nanite: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNTT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NANITE Core"), this);
    aboutAction->setStatusTip(tr("Show information about NANITE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NANITE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NANITE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NANITE addresses"));
    ...
    openAction->setStatusTip(tr("Open a NANITE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NANITE Core help message to get a list with possible NANITE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NANITE Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("NANITE Core"); // default title
