 ...
 */
    ...
    typeWidget->addItem(tr("Received Ntt from zNtt"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zNtt"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zNtt));
