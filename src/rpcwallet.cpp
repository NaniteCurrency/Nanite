...
UniValue getnewaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "\"naniteaddress\"    (string) The new nanite address\n"
            "\nExamples:\n" +
...
UniValue getaccountaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "\"naniteaddress\"   (string) The account nanite address\n"
            "\nExamples:\n" +
...
UniValue getrawchangeaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new Nanite address, for receiving change.\n"
...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"naniteaddress\"  (string, required) The nanite address to be associated with an account.\n"
            "2. \"account\"         (string, required) The account to assign the address to.\n"
            "\nExamples:\n" +
            HelpExampleCli("setaccount", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\" \"tabby\"") + HelpExampleRpc("setaccount", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\", \"tabby\""));
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"naniteaddress\"  (string, required) The nanite address for account lookup.\n"
            "\nResult:\n"
            "\"accountname\"        (string) the account address\n"
            "\nExamples:\n" +
            HelpExampleCli("getaccount", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\"") + HelpExampleRpc("getaccount", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\""));
...
UniValue getaddressesbyaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"naniteaddress\"  (string) a nanite address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n" +
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"naniteaddress\"  (string, required) The nanite address to send to.\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("sendtoaddress", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\" 0.1") + HelpExampleCli("sendtoaddress", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\" 0.1 \"donation\" \"seans outpost\"") + HelpExampleRpc("sendtoaddress", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\", 0.1, \"donation\", \"seans outpost\""));
...
UniValue sendtoaddressix(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            "sendtoaddressix \"naniteaddress\" amount ( \"comment\" \"comment-to\" )\n"
            "\nSend an amount to a given address. The amount is a real and is rounded to the nearest 0.00000001\n" +
            HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"naniteaddress\"  (string, required) The nanite address to send to.\n"
            ...
            "\"transactionid\"  (string) The transaction id.\n"
            "\nExamples:\n" +
            HelpExampleCli("sendtoaddressix", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\" 0.1") + HelpExampleCli("sendtoaddressix", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\" 0.1 \"donation\" \"seans outpost\"") + HelpExampleRpc("sendtoaddressix", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\", 0.1, \"donation\", \"seans outpost\""));
...
UniValue listaddressgroupings(const UniValue& params, bool fHelp)
{
    if (fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"naniteaddress\",     (string) The nanite address\n"
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            HelpRequiringPassphrase() + "\n"
                                        "\nArguments:\n"
                                        "1. \"naniteaddress\"  (string, required) The nanite address to use for the private key.\n"
            ...
            "\nCreate the signature\n" + HelpExampleCli("signmessage", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\" \"my message\"") +
            "\nVerify the signature\n" + HelpExampleCli("verifymessage", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\" \"signature\" \"my message\"") +
            "\nAs json rpc\n" + HelpExampleRpc("signmessage", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\", \"my message\""));
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "getreceivedbyaddress \"naniteaddress\" ( minconf )\n"
            "\nReturns the total amount received by the given naniteaddress in transactions with at least minconf confirmations.\n"
            "\nArguments:\n"
            "1. \"naniteaddress\"  (string, required) The nanite address for transactions.\n"
            "2. minconf             (numeric, optional, default=1) Only include transactions confirmed at least this many times.\n"
            "\nResult:\n"
            "amount   (numeric) The total amount in btc received at this address.\n"
            "\nExamples:\n"
            "\nThe amount from transactions with at least 1 confirmation\n" +
            HelpExampleCli("getreceivedbyaddress", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n" + HelpExampleCli("getreceivedbyaddress", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n" + HelpExampleCli("getreceivedbyaddress", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\" 6") +
            "\nAs a json rpc call\n" + HelpExampleRpc("getreceivedbyaddress", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\", 6"));
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw runtime_error(
            "sendfrom \"fromaccount\" \"tonaniteaddress\" amount ( minconf \"comment\" \"comment-to\" )\n"
            "\nSent an amount from an account to a nanite address.\n"
            "The amount is a real and is rounded to the nearest 0.00000001." +
            HelpRequiringPassphrase() + "\n"
                                        "\nArguments:\n"
                                        "1. \"fromaccount\"       (string, required) The name of the account to send funds from. May be the default account using \"\".\n"
                                        "2. \"tonaniteaddress\"  (string, required) The nanite address to send funds to.\n"
            ...
            HelpExampleCli("sendfrom", "\"\" \"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n" + HelpExampleCli("sendfrom", "\"tabby\" \"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n" + HelpExampleRpc("sendfrom", "\"tabby\", \"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\", 0.01, 6, \"donation\", \"seans outpost\""));
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            HelpRequiringPassphrase() + "\n"
                                        ...
                                        "    {\n"
                                        "      \"address\":amount   (numeric) The nanite address is the key, the numeric amount in btc is the value\n"
                                        "      ,...\n"
                                        "    }\n"
            ...
            HelpExampleCli("sendmany", "\"tabby\" \"{\\\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\\\":0.01,\\\"nT9bWzJQU1pDhVgWyHixQEZgezY7PcwDcB\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n" + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\\\":0.01,\\\"nT9bWzJQU1pDhVgWyHixQEZgezY7PcwDcB\\\":0.02}\" 6 \"testing\"") +
            "\nAs a json rpc call\n" + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\\\":0.01,\\\"nT9bWzJQU1pDhVgWyHixQEZgezY7PcwDcB\\\":0.02}\", 6, \"testing\""));
    ...
    BOOST_FOREACH(const string& name_, keys) {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Nanite address: ")+name_);
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3) {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
                     ...
                     "2. \"keysobject\"   (string, required) A json array of nanite addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"address\"  (string) nanite address or hex-encoded public key\n"
                     "       ...,\n"
                     "     ]\n"
                     "3. \"account\"      (string, optional) An account to assign the addresses to.\n"

                     "\nResult:\n"
                     "\"naniteaddress\"  (string) A nanite address associated with the keys.\n"

                     "\nExamples:\n"
                     "\nAdd a multisig address from 2 addresses\n" +
                     HelpExampleCli("addmultisigaddress", "2 \"[\\\"nMpwFKoEYH97R491dAjGqXxiwVKYDfX4FV\\\",\\\"nEiRsvqop32iZYh5p2Tg3Sdynvnyv2oNjL\\\"]\"") +
                     "\nAs json rpc call\n" + HelpExampleRpc("addmultisigaddress", "2, \"[\\\"nMpwFKoEYH97R491dAjGqXxiwVKYDfX4FV\\\",\\\"nEiRsvqop32iZYh5p2Tg3Sdynvnyv2oNjL\\\"]\"");
...
UniValue listtransactions(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 4)
        throw runtime_error(
            ...
            "    \"address\":\"naniteaddress\",    (string) The nanite address of the transaction. Not present for \n"
...
UniValue listsinceblock(const UniValue& params, bool fHelp)
{
    if (fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"naniteaddress\",    (string) The nanite address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "      \"address\" : \"naniteaddress\",   (string) The nanite address involved in the transaction\n"
...
UniValue walletpassphrase(const UniValue& params, bool fHelp)
{
    if (pwalletMain->IsCrypted() && (fHelp || params.size() < 2 || params.size() > 3))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending NTTs\n"
            "\nArguments:\n"
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            "\nPerform a send (requires passphrase set)\n" + HelpExampleCli("sendtoaddress", "\"nBBsLopcTaRNt6XyaQeDKgEf1CDvJFP9MF\" 1.0") +
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending NTTs\n" + HelpExampleCli("walletpassphrase", "\"my pass phrase\"") +
            "\nNow we can so something like sign\n" + HelpExampleCli("signmessage", "\"naniteaddress\" \"test message\"") +
...
UniValue lockunspent(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending NTTs.\n"
...
UniValue settxfee(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. amount         (numeric, required) The transaction fee in NTT/kB rounded to the nearest 0.00000001\n"
            "\nResult\n"
...
UniValue getwalletinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total NTT balance of the wallet\n"
...
UniValue autocombinerewards(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || (fEnable && params.size() != 2) || params.size() > 2)
        throw runtime_error(
            ...
            "\nWallet will automatically monitor for any coins with value below the threshold amount, and combine them if they reside with the same Nanite address\n"
...
UniValue multisend(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            "multisend <Nanite Address> <percent>\n"
    ...
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid NTT address");
...
UniValue mintzerocoin(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "mintzerocoin <amount>\n"
            "Usage: Enter an amount of Ntt to convert to zNtt"
            + HelpRequiringPassphrase());

    int64_t nTime = GetTimeMillis();

    if(GetAdjustedTime() > GetSporkValue(SPORK_16_ZEROCOIN_MAINTENANCE_MODE))
        throw JSONRPCError(RPC_WALLET_ERROR, "zNTT is currently disabled due to maintenance.");
...
UniValue spendzerocoin(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 5 || params.size() < 4)
        throw runtime_error(
            ...
            "Overview: Convert zNTT (zerocoins) into NTT. \n"
            "amount: amount to spend\n"
            "mintchange: if there is left over NTT (change), the wallet can convert it automatically back to zerocoins [true]\n"
    ...
    bool fMintChange = params[1].get_bool();        // Mint change to zNTT
    ...
    if(fHelp || params.empty() || params.size() > 2)
        throw runtime_error(
            "exportzerocoins include_spent ( denomination )\n"
                ...
                "2. \"denomination\"         (integer, optional) Export a specific denomination of zNtt\n"
    ...
    if(fHelp || params.size() == 0)
        throw runtime_error(
            "importzerocoins importdata \n"
                ...
                "\"value\"            (string) the total zNtt value of zerocoin mints that were added\n"
...
UniValue reconsiderzerocoins(const UniValue& params, bool fHelp)
{
    if(fHelp || !params.empty())
        throw runtime_error(
            "reconsiderzerocoins\n"
                "\nCheck archived zNtt list to see if any mints were added to the blockchain.\n"
