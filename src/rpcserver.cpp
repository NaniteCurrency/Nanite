...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NANITE features */
        {"nanite", "masternode", &masternode, true, true, false},
        {"nanite", "listmasternodes", &listmasternodes, true, true, false},
        {"nanite", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nanite", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nanite", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nanite", "masternodedebug", &masternodedebug, true, true, false},
        {"nanite", "startmasternode", &startmasternode, true, true, false},
        {"nanite", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nanite", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nanite", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nanite", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nanite", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nanite", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nanite", "mnbudget", &mnbudget, true, true, false},
        {"nanite", "preparebudget", &preparebudget, true, true, false},
        {"nanite", "submitbudget", &submitbudget, true, true, false},
        {"nanite", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nanite", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nanite", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nanite", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nanite", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nanite", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nanite", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nanite", "checkbudgets", &checkbudgets, true, true, false},
        {"nanite", "mnsync", &mnsync, true, true, false},
        {"nanite", "spork", &spork, true, true, false},
        {"nanite", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"nanite", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> nanite-cli " + methodname + " " + args + "\n";
}
