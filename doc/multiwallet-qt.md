...
In order to support loading of multiple wallets in nanite-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nanite.cpp.
...
Changes to nanite.cpp
----------------------
nanite.cpp is the entry point into nanite-qt, and as such, will require some minor modifications to provide hooks for
