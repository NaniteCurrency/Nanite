...
#   c) node1 mines 32 blocks, so now node 0 has 60001ntt, node 1 has 4250ntt, node2 has none.
#   d) node0 sends 601 ntt to node2, in two transactions (301 ntt, then 300 ntt).
