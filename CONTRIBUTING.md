Contributing to NANITE Core
============================

The NANITE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NANITE Core project, and is not to be
confused with overall NANITE Network Protocol consensus changes.

Whether a pull request is merged into NANITE Core rests with the project merge
...
Patches that change NANITE consensus rules are considerably more involved than
...
Where a patch set proposes to change the NANITE consensus, it must have been
...
The project leader is the release manager for each NANITE Core release.
