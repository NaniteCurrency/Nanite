...
pkgdatadir = $(datadir)/nanite
pkgincludedir = $(includedir)/nanite
pkglibdir = $(libdir)/nanite
pkglibexecdir = $(libexecdir)/nanite
...
CONFIG_HEADER = $(top_builddir)/src/config/nanite-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/nanite-config.h.in \
...
ACLOCAL = ${SHELL} /home/gabriel/Desktop/NANITE2/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/gabriel/Desktop/NANITE2/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/gabriel/Desktop/NANITE2/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/gabriel/Desktop/NANITE2/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = nanite-cli
BITCOIN_DAEMON_NAME = nanited
BITCOIN_GUI_NAME = nanite-qt
BITCOIN_TX_NAME = nanite-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/gabriel/Desktop/NANITE2/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = nanite
PACKAGE_BUGREPORT = www.nanite.org
PACKAGE_NAME = Nanite Core
PACKAGE_STRING = Nanite Core 3.0.99
PACKAGE_TARNAME = nanite
PACKAGE_URL = 
PACKAGE_VERSION = 3.0.99
PATH_SEPARATOR = :
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/gabriel/Desktop/NANITE2
abs_srcdir = /home/gabriel/Desktop/NANITE2
abs_top_builddir = /home/gabriel/Desktop/NANITE2
abs_top_srcdir = /home/gabriel/Desktop/NANITE2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/gabriel/Desktop/NANITE2/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_nanite_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_nanite_coverage.info test_nanite.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/NANITE-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/nanite-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/nanite-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/nanite-config.h
$(top_srcdir)/src/config/nanite-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/nanite-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/NANITE-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/NANITE-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/NANITE-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_nanite.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_nanite -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_nanite_filtered.info: test_nanite.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_nanite_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_nanite_coverage.info: baseline_filtered_combined.info test_nanite_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_nanite_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_nanite_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_nanite_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_nanite.coverage/.dirstamp:  test_nanite_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_nanite.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_nanite.coverage/ total.coverage/ $(OSX_APP)
